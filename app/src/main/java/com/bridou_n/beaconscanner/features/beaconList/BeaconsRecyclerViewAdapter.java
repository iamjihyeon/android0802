        ...
        if (getItemViewType(position) != VIEW_TYPE_FOOTER) {
            ...
            switch (getItemViewType(position)) {
                ...
                case VIEW_TYPE_IBEAON_ALTBEACON:
                    ...
                    String primitiveUUID = b.getUUID();

                    char yaw0, pitch0, roll0;

                    if (primitiveUUID.charAt(1) == '0')
                         yaw0 = '+';
                    else yaw0 = '-';
                    char yaw100 = primitiveUUID.charAt(3);
                    char yaw10 = primitiveUUID.charAt(5);
                    char yaw1 = primitiveUUID.charAt(7);

                    if (primitiveUUID.charAt(10) == '0')
                        pitch0 = '+';
                    else pitch0 = '-';
                    char pitch100 = primitiveUUID.charAt(12);
                    char pitch10 = primitiveUUID.charAt(15);
                    char pitch1 = primitiveUUID.charAt(17);

                    if (primitiveUUID.charAt(20) == '0')
                        roll0 = '+';
                    else roll0 = '-';
                    char roll100 = primitiveUUID.charAt(22);
                    char roll10 = primitiveUUID.charAt(25);
                    char roll1 = primitiveUUID.charAt(27);


                    h.proximityUUID.setText(primitiveUUID +"\n"+"yaw = "+yaw0+yaw100+yaw10+yaw1+
                            " pitch = "+pitch0+pitch100+pitch10+pitch1+
                            " roll = "+roll0+roll100+roll10+roll1);
                    //h.proximityUUID.setText(b.getUUID()+"미미");
